...
$onepage = $this->params->get('onepage');
$bannerbg = $this->params->get('bannerbg');
$responsive = $this->params->get('responsive');
$bannercolor = $this->params->get('bannercolor');
$bannerwidth = $this->params->get('bannerwidth');
$copyframe = dirname(__FILE__).DIRECTORY_SEPARATOR.'copyframe.php';
